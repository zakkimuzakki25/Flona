import bg from "../../assets/images/background/Volunteer.jpeg"
...
const VolunteerDetail = () => {
  ...
  return (
    <div>
      ...
      <InfoDetail
        bg={bg} 
        h1={"daftarkan diri kalian dan jadi bagian dari kami"} 
        h2={"Bergabung bersama demi membantu mewujudkan lingkungan masa depan yang lebih baik."} 
        link_text={"DAFTAR SEKARANG"}
        title1={"apa pentingnya peran volunteer dalam kegiatan ini?"}
        title2={"kenapa dibutuhkan volunteer?"}
